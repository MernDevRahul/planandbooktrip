...
export default function CategoryPage({ params }) {
  let {
    categories,
    companyData,
    packageData: tempPackageData,
    allPageMetadata,
  } = useContext(seoContextObj);
  ...
  function fetchPackageData() {
    ...
    if (category === "trips") {
      ...
      data = data
        ?.filter((item) => item.categoryId.slugName === category)
        .reverse();
    }
    ...
    data?.forEach((trip) => {
      if (
        trip.subCategoryId?.name &&
        !subCategoryName.includes(trip.subCategoryId.name)
      ) {
  ...
  function handleSelectedCategoryName(name) {
    setSelectedSubCategoryName((prev) =>
      prev.includes(name) ? prev.filter((sub) => sub !== name) : [...prev, name]
    );
  }
      ...
      {isLoading === true ? (
        ...
        <>
          <section
            ...
            style={{
              backgroundImage: `url(${tripBanner.src})`,
              height: "300px",
              width: "100%",
                          ...
                          <div class="tour-block-one">
                            <div class="inner-box">
                              ...
                              <div class="lower-content">
                                <div class="rating">
                                  <span>
                                    <i class="fas fa-star"></i>8.0 Superb
                                  </span>
                                </div>
                                <h3>
                                  <a href="tour-details">
                        ...
                        return (
                          <div class="tour-block-two">
                            <div class="inner-box">
                              ...
                              >
                                <img
                                  src={`${SERVER_URL}/${item.packageImage}`}
                                  alt=""
                  ...
                  <div class="default-sidebar tour-sidebar ml-20">
                              ...
                              <div class="custom-controls-stacked">
                                <label class="custom-control material-checkbox">
                                  <input
                                    ...
                                    checked={selectedSubCategoryName.includes(
                                      name
                                    )}
                                    onChange={() =>
                    ...
                    {/* <div className="advice-widget">
                      ...
                      >
                        <div className="text">
                          <h2>
                            Get <br /> 25% Off <br /> On New York Tours
                          </h2>
                        </div>
                      </div>
                    </div> */}
